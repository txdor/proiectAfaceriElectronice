        ...
        <Col md={8}>
          <ListGroup variant='flush'>
            <ListGroup.Item>
              ...
              {order.isDelivered ? (
                <Message variant='success'>
                  Livrat pe data de {order.deliveredAt}
                </Message>
              ) : (
            ...
            <ListGroup.Item>
              ...
              {order.isPaid ? (
                <Message variant='success'>Plătit pe data: {order.paidAt}</Message>
              ) : (
            ...
            <ListGroup.Item>
              ...
              {order.orderItems.length === 0 ? (
                <Message>Comanda este goală</Message>
              ) : (
                <ListGroup variant='flush'>
