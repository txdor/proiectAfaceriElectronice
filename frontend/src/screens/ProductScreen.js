          ...
          <Row>
            ...
            <Col md={3}>
              <ListGroup variant='flush'>
                ...
                <ListGroup.Item>Preț: {product.price}LEI</ListGroup.Item>
                <ListGroup.Item>
                ...
                <ListGroup variant='flush'>
                  ...
                  <ListGroup.Item>
                    <Row>
                      <Col>Status:</Col>
                      <Col>
                        {product.countInStock > 0 ? 'În Stoc' : 'Stoc epuizat'}
                      </Col>
                    </Row>
                  </ListGroup.Item>
                  ...
                  {userInfo ? (
                    <Form onSubmit={submitHandler}>
                      ...
                      <Form.Group controlId='comment'>
                        <Form.Label>Scrie recenzia</Form.Label>
                        <Form.Control
                          as='textarea'
                          row='3'
                          value={comment}
